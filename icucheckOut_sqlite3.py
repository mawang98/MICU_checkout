...
class CheckinOut(QtWidgets.QMainWindow):
    ...
    def signalToSlot(self):
        ...
        self.ui.tableWidget.itemDoubleClicked.connect(self.tableDubleClickedGetData)
    ...
    def searchTheAdmnum(self,admnum,dischargeDate):
        ...
        try:
            a = ReadTable().readDatasWithAdmnum(adnmumToSearch)
            for i in a:
...
#################修改数据##################################################
    def tableDubleClickedGetData(self):
        ...
        self.alter.ui.comboBox_7.setCurrentText(a[0][1])
